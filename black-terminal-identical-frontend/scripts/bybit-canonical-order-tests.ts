...
assert.doesNotMatch(disconnectSource, /findCredentialDuplicateAccountIds/);
assert.match(disconnectSource, /accountIdsToDelete = \[account\.id\]/);
assert.match(disconnectSource, /broker_secret_references/);
assert.match(disconnectSource, /broker_automation_mandates/);
