...
const builtInIndicators: BuiltInIndicator[] = [
  ...
  { key: "bollinger", title: "Bollinger Bands", group: "Volatility", type: "Bands", signal: "2 sigma envelope", periodKey: "bollinger", min: 5, max: 300 },
  {
    ...
    type: "Oscillator + Adaptive Swing Alerts",
    signal: "Original 0–10 composite plus optional regime percentiles and causal EVT-confirmed swing extremes",
    runtime: "Python",
  ...
  },
  {
    ...
    group: "Black Core / CVD Analytics",
    type: "Oscillator + Market State",
    signal: "Candle-signed OHLCV CVD, adaptive fast/slow waves and LONG/SHORT/SIDEWAYS regime",
    runtime: "Native",
    periodKey: "cvdOscillator",
    min: 100,
    max: 20000
  },
  {
