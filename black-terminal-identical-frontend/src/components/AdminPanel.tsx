...
const ALL_INDICATORS_METADATA = [
  ...
  { key: "marketSentimentOscillator", name: "BC-MSO — Market Sentiment Oscillator", desc: "Causal multi-factor sentiment with optional regime-percentile and EVT-confirmed swing extremes" },
