...
export function TargetsStep({ draft, bindings, eligible, busy, onRefreshTargets, onManageTargets, onChange }: {
  ...
  return <div className="strategy-wizard-section">
    ...
    <div className="strategy-destination-grid">
      <Destination active={plan.targetType === "PAPER"} disabled={busy} icon={<ShieldCheck size={18} />} title="Paper Backtester" text="Black Cloud simulated account. No broker order can be submitted." onClick={() => chooseType("PAPER")} />
