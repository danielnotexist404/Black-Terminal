    ...
    <div className="indicator-settings kioseff-settings" role="dialog" aria-label="Market Maker Heatmap settings" data-testid="kioseff-settings-panel">
      ...
      {tab === "style" && (
        <div className="indicator-settings-section">
          ...
          <label>Buy Wall Color<input data-kioseff-field="style.buyWallColor" type="color" value={settings.style.buyWallColor} onChange={(event) => patchStyle({ buyWallColor: event.target.value })} /></label>
