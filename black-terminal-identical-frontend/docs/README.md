...
Phase V Chapter IV Black Capital Network documentation is under `docs/investment-groups/`. Start with `BLACK_CAPITAL_NETWORK_OVERVIEW.md`, the implementation audit and completion report. Copy Trading is server-executed and immediately revocable; Obsidian is future research only.
