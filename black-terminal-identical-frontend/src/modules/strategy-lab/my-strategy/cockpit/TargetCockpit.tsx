import { Link2Off, Pause, Play, ShieldCheck } from "lucide-react";
import type { StrategyTargetBinding, StrategyTargetSnapshot } from "../../automation/strategyAutomation.types";

export function TargetCockpit({ binding, snapshot, busy, onAction, onDisconnect }: { binding: StrategyTargetBinding; snapshot?: StrategyTargetSnapshot; busy: boolean; onAction: (action: "arm" | "pause" | "resume") => void; onDisconnect: () => void }) {
