import type { AifAuctionNode, AifLvnZone, AifProfileConfluence, AifProfileResult, AifRenderModel, AifTimelineEvent } from "../core/aifTypes";
import type { AifImmContext } from "../imm/aifImmBridge";

export function buildAifRenderModel(primary: AifProfileResult, primaryNodes: AifAuctionNode[], lvnZones: AifLvnZone[], projectedLvns: AifLvnZone[], secondary: AifProfileResult | undefined, secondaryNodes: AifAuctionNode[], confluence: AifProfileConfluence[], events: AifTimelineEvent[], chob: AifRenderModel["auctionStateSummary"]["chob"], imm: AifImmContext, currentPrice: number, calculationMs: number, timings: AifRenderModel["timings"]): AifRenderModel {
  ...
  return {
    ...
    renderVersion: "aif-render/1.1.0",
    calculationMs,
    timings,
    cacheState: "miss"
  };
