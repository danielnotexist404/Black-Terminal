...
export function evaluateOrderRisk(
  ...
  if (controls.maxPositionUsd > 0 && notional > controls.maxPositionUsd) {
  ...
  if (controls.maxPortfolioExposureUsd > 0 && account.marginUsed + requiredMargin > controls.maxPortfolioExposureUsd) {
