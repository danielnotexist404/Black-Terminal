...
The sprite is projected with the chart's `xForTime` and `yForPrice` transforms and clipped to the plot. Candles are later in the Pixi layer stack and therefore remain crisp.
