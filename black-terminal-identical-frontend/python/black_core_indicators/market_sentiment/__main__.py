...
def main() -> None:
    ...
    aliases = {
        ...
        "tailConfidence": "tail_confidence",
        "evtThresholdPercentile": "evt_threshold_percentile",
        "evtMinimumTailSamples": "evt_minimum_tail_samples",
        "atrLength": "atr_length",
        "regimeLength": "regime_length",
        "regimeSlopeLength": "regime_slope_length",
        "regimeThreshold": "regime_threshold",
        "trendExpansion": "trend_expansion",
        "minimumTailDwell": "minimum_tail_dwell",
        "structureLength": "structure_length",
        "requireStructureConfirmation": "require_structure_confirmation",
