...
export function updateModeSettings(settings: DomSettings, mode: DomMode): DomSettings {
  ...
  return {
    ...
    cvdCandleSeconds: nextMode === "scalper" ? 30 : nextMode === "intraday" ? 120 : nextMode === "macro" ? 900 : 300,
    cvdVisibleCandles: nextMode === "scalper" ? 36 : nextMode === "macro" ? 72 : 48,
    depthDisplayLevels: nextMode === "scalper" ? 80 : nextMode === "macro" ? 240 : 180,
