...
export interface BclifRecoveredActiveBucket<T extends BclifTimestampedColumn> {
  ...
  discardRecoveredBucketOnResume: boolean;
...
export function recoverLatestActiveBucket<T extends BclifTimestampedColumn>(
  ...
  if (!columns.length) return { columns: [], bucketStart: null, suppressReplayPublicationThrough: null, discardRecoveredBucketOnResume: false, droppedColumns: 0, droppedBuckets: 0 };
  ...
  return {
    ...
    discardRecoveredBucketOnResume: firstNewestIndex > 0,
