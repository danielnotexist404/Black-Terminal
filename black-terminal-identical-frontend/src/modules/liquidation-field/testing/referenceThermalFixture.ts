...
export function createBclifReferenceThermalStyleFixture(columns = 320, rows = 180): BclifDisplayProjection {
  ...
  return {
    ...
    maximumAlpha: 255,
    rawExposureMinimum: 1,
    rawExposureMaximum: 255,
    normalizedScalarMinimum: 15 / 255,
    normalizedScalarMaximum: 1,
    confidenceMinimum: 104 / 255,
    confidenceMaximum: 234 / 255,
    validityRatio: validCells / cells,
